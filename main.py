...
plt.savefig(os.path.join("plots", "02.dataset_scatter.png"))
...
plt.savefig(os.path.join("plots", "03.linear_svm_results.png"))
...
plt.savefig(os.path.join("plots", "04.gaussian_svm_results.png"))
...
plt.savefig(os.path.join("plots", "05.training_input_scatter.png"))
# plt.show()
...
plt.savefig(os.path.join("plots", "06.test_set_scatter.png"))
# plt.show()

plt.scatter(test_input['Benign'][:, 0], test_input['Benign'][:, 1])
plt.scatter(test_input['Malignant'][:, 0], test_input['Malignant'][:, 1])
plt.savefig(os.path.join("plots", "07.test_input_scatter.png"))
# plt.show()
